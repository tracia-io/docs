...
The Python SDK uses [LiteLLM](https://docs.litellm.ai/) under the hood for unified provider access. LiteLLM is included as a dependency — no additional provider packages are needed.
