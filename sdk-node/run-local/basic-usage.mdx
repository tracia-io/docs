...
Install the Tracia SDK and the provider SDK(s) you need:

<CodeGroup>
```bash OpenAI
npm install tracia openai
```

```bash Anthropic
npm install tracia @anthropic-ai/sdk
```

```bash Google
npm install tracia @google/generative-ai
```

```bash All Providers
npm install tracia openai @anthropic-ai/sdk @google/generative-ai
```
</CodeGroup>
...
// View this trace in the Tracia dashboard
```
