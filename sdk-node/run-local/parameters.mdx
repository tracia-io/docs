...
| `customOptions` | `Record<string, unknown>` | `undefined` | Provider-specific options passed to the underlying SDK |
...
Pass provider-specific options that aren't directly supported:
