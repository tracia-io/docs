...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| `temperature` | `number` | Provider default | Controls randomness (0-2 for OpenAI/Google, 0-1 for Anthropic, vendor-dependent for Bedrock) |
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| `provider` | `'openai' \| 'anthropic' \| 'google' \| 'amazon_bedrock'` | Auto-detected | Override provider detection for custom models |
